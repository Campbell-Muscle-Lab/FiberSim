...
# import demos.getting_started.single_run.single_run

# from mods.batch.batch import run_batch
# from demos.getting_started.single_run.single_run import demo_single_run
...
#         if (sys.argv[1] == "demo"):
#             if (sys_arv[2] == "getting_started"):
#                 if (sys_argv[3] == "single_run"):
