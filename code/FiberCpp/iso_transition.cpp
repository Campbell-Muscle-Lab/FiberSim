...
// Constructor
iso_transition::iso_transition(const rapidjson::Value& iso_tr, int set_parent_isotype)
{
	// Set p_parent_m_state
	parent_isotype = set_parent_isotype;

	JSON_functions::check_JSON_member_int(iso_tr, "new_number");
	new_isotype = iso_tr["new_isotype"].GetInt();
